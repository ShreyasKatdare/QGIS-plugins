...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'shifted_faces_heatmap_dialog_base.ui'))


class shifted_faces_heatmapDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, iface, parent=None):
        """Constructor."""
        super(shifted_faces_heatmapDialog, self).__init__(parent)
    ...
    def load_maps(self):
        maps = ["farmplots", "survey_georeferenced", "shifted_faces"]
    ...
    def generate_heatmap(self, attribute):
        ...
        layer = QgsProject.instance().mapLayersByName("shifted_faces")[0]
        field = attribute
